...
**[Download the complete Windows installer](https://github.com/MrElectronicOps/NeuralFlow/releases/download/v0.6.0-preview.7/NeuralFlowPreviewSetup.exe)** · [Portable ZIP](https://github.com/MrElectronicOps/NeuralFlow/releases/download/v0.6.0-preview.7/NeuralFlow-Preview.zip)
