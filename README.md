...
**[Download the complete Windows installer](https://github.com/MrElectronicOps/NeuralFlow/releases/download/v0.6.0-preview.6/NeuralFlowPreviewSetup.exe)** · [Portable ZIP](https://github.com/MrElectronicOps/NeuralFlow/releases/download/v0.6.0-preview.6/NeuralFlow-Preview.zip)
